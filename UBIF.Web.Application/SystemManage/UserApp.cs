...
* 作    者 ：welus
* 创建时间 ：2019/5/20 21:37:38
* 更新时间 ：2019/5/20 21:37:38
* 版 本 号 ：v1.0.0.0
*******************************************************************
    ...
    public class UserApp
    {
        ...
        public void SubmitForm(SysUser userEntity, SysUserlogon userLogOnEntity, string keyValue)
        {
            if (!string.IsNullOrEmpty(keyValue))
            {
                ...
                if (LoginInfo != null)
                {
                    userEntity.FLastModifyUserId = LoginInfo.UserId;
                }
                userEntity.FLastModifyTime = DateTime.Now;
            }
            else
            {
                userEntity.FId = Common.GuId();
                var LoginInfo = OperatorProvider.Provider.GetCurrent();
                if (LoginInfo != null)
                {
                    userEntity.FCreatorUserId = LoginInfo.UserId;
                }
                userEntity.FCreatorTime = DateTime.Now;
            }
