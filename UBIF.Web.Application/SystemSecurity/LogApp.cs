#region << 版 本 注 释 >>
/*----------------------------------------------------------------
* 项目名称 ：UBIF.Web.Application.SystemSecurity
* 项目描述 ：
* 类 名 称 ：LogApp
* 类 描 述 ：
* 所在的域 ：DESKTOP-O4LCU7F
* 命名空间 ：UBIF.Web.Application.SystemSecurity
* 机器名称 ：DESKTOP-O4LCU7F 
* CLR 版本 ：4.0.30319.42000
* 作    者 ：welus
* 创建时间 ：2019/5/20 21:55:53
* 更新时间 ：2019/5/20 21:55:53
* 版 本 号 ：v1.0.0.0
*******************************************************************
...
using UBIF.Web.Code;
using UBIF.Web.Data;
using UBIF.Web.Domain.SystemSecurity;
using UBIF.Web.Repository.SystemSecurity;

namespace UBIF.Web.Application.SystemSecurity
{
    public class LogApp
    {
        ...
        public void WriteDbLog(bool result, string resultLog)
        {
            ...
            if(LoginInfo!=null)
            {
                logEntity.FCreatorUserId = LoginInfo.UserId;
            }
            logEntity.FCreatorTime = DateTime.Now;
